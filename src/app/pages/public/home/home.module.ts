...
@NgModule({
  declarations: [HomeComponent, IndicatorComponent, RemarkableAreaComponent, MultimediaGalleryComponent, ContactFormComponent, ReportSummaryComponent, SideBarComponent],
  imports: [
    CommonModule,
